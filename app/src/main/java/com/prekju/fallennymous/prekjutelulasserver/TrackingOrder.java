...
import com.prekju.fallennymous.prekjutelulasserver.Common.DirectionJSONParser;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        private void displayLocation() {
            ...
            else
            {
                ...
                if (mLastLocation != null)
                {
                    ...
                    mMap.addMarker(new MarkerOptions().position(yourLocation).title("Lokasi kamu"));
                    ...
                    Log.d("DEBUG","Tidak bisa mendapatkan lokasi");
                }
            }
        }
                ...
                public void onResponse(Call<String> call, Response<String> response) {
                    try{
                        ...
                        MarkerOptions marker = new MarkerOptions().icon(BitmapDescriptorFactory.fromBitmap(bitmap))
                                .title("Pesanan dari "+Common.currentRequest.getPhone())
        ...
        private boolean checkPlayService() {
            ...
            if (resultCode != ConnectionResult.SUCCESS)
            {
                ...
                {
                    Toast.makeText(this, "Perangkat tidak di dukung", Toast.LENGTH_SHORT).show();
                    finish();
                }
                return false;
            }
